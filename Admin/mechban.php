...
if(isset($_POST['ban'])){
    ...
    $mail = new PHPMailer(true);                            
        ...
        $mail->SMTPAuth = true;                             
        $mail->Username = 'Mechanic_Now22@gmail.com';     
        ...
        //Send Email
        $mail->setFrom('Mechanic_Now22@gmail.com');
 
        //Recipients
        $mail->addAddress($email);              
        $mail->addReplyTo('Mechanic_Now22@gmail.com');
    ...
    $sql="UPDATE mechanic set status='banned' where mechID=:regeditid";
    $query=$dbh->prepare($sql); 
    $query->bindParam(':regeditid',$regeditid,PDO::PARAM_STR); 
    $query->execute();
   
    echo "<script type='text/javascript'>alert('Banned Success');</script>";
                            ...
                            <div class="row d-flex justify-content-start px-4 "> 
                                ...
                                <div class="float-end">
                                    <button class="btn btn-warning btn-lg" type="submit" id="ban" name="ban"
                                        value="banned"><i class="bi bi-exclamation-circle"></i> Banned</button>
                                </div>
                            </div>
                            <div class="col-lg-8">
