                            ...
                            <li class="nav-item dropdown w-100">
                                ...
                                <ul class="dropdown-menu w-100" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a href="banlist.php" class="dropdown-item pl-4 p-2"><i
                                                ...
                                                <li><a href="userbanlist.php" class="dropdown-item pl-4 p-2 active"><i
            ...
            <main class="col px-0 flex-grow-1">
                <div class="container-fluid  py-3">
                    <section class="container-fluid">
                        <div class="display-6 my-2">Banned Vehicle Owner</div>
                        ...
                        <form method="POST">
                            <?php
											...
											$sql = "SELECT * from customer WHERE ban='banned' and username LIKE :keyword order by custID ";
                                            ...
                                            <table class="table" style="overflow-y: visible;">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0 Phead">Type of Vehicle</th>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-secondary btn-lg"
                                                                href="unbanuser.php?regeditid=<?php echo htmlentities($result->custID)?>"
                                                                data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                                title="Unbanned Mechanic"><i class="bi bi-person-check-fill"></i></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <?php $cnt=$cnt+1;}}
