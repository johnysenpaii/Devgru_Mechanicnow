...
if(isset($_POST['ban'])){
    ...
    echo "<script type='text/javascript'>alert('Account Resume Success');</script>";
            ...
            <main class="col px-0 flex-grow-1">
                <div class="container py-3">
                    <section class="my-container">
                        <div class="display-6 my-2">Unbanned Mechanic</div>
                            ...
                            <div class="row d-flex justify-content-start px-4 ">
                                ...
                                <div class="float-end">
                                    <button class="btn btn-success btn-lg" type="submit" id="ban" name="ban"
                                        value="banned"><i class="bi bi-person-check-fill"></i> Unbanned</button>
                                </div>
                            </div>
                            <?php }}?>
                        </form>
