...
if(isset($_POST["verify"])){
  ...
  $sql12="UPDATE mechanic set status='approve' WHERE mechID=:regeditid1"; //,Password=:Password ,Specialization=:Specialization,mechValidID=:mechValidID
  $query12=$dbh->prepare($sql12);
  $query12->bindParam(':regeditid1',$mechID1,PDO::PARAM_STR); 
  $query12->execute(); 
            ...
            <div class="row container-fluid py-3 text-dark">
                <div class="col-sm-12 col-md-6">
                    ...
                    <h5 class="text-start pt-2">Vehicle Owner Information</h6>
                        ...
                        <?php
                        $d = explode(',' ,$result->mechRepair  );
                    
                        foreach(explode(',', $result->mechRepair) as $ing) { 
                                ?>
                                    <input class="<?php echo htmlentities($ing)?>" onclick="totalIt()" type="checkbox" id="box" name="lenghtCheckbox" value="" <?php if(isset($_POST["lenghtCheckbox"])){ echo (strcmp($ing, $d[0]) && strcmp($ing, $d[1]) && strcmp($ing, $d[2]) && strcmp($ing, $d[3]) && strcmp($ing, $d[4]) && strcmp($ing, $d[5]) ? 'unchecked' : 'checked');}?>> <label for="box"><?php echo htmlentities($ing)?></label> <br>
                        <?php  }?>
                    ...
                    <div id="msg"></div>
                        ...
                        <input  type="text" name="output" class="border-0"  value="100" id="output">
