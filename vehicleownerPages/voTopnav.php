...
<section id="nav-top" class="d-none d-md-block top-navigation container-fluid">
        <div class="row">
            ...
            <div class="d-flex justify-content-center pt-3">
                <a href="vomapShops.php" class="py-1 px-5 mx-1 bg-white text-dark rounded-pill btn position-relative">Find Mechanic Shops</a>
                <a href="voActivityLog.php" class="py-1 px-5 mx-1 bg-white text-dark rounded-pill btn position-relative">
                    <span id="hide3" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
                                <?php 
