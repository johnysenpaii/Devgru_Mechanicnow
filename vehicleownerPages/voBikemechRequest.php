    ...
    if(empty($mechRepairInsert)){
        ...
        try{
            if(!isset($errorMsg)){
                ...
                header("Location:voBikemechRequest.php?/requestForm=$msgFailed");
            }
                ...
                if($query43->rowCount()>0){
                    foreach ($results as $result43) {?>
                        ...
                        <div class="request-form" style="color: #302D32">
                            ...
                            <div class="request-content text-start">
                                ...
                                <div class="repair-list" id="repairbox">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="flexCheckDefault"
                                            name="mechRepair[]" value="Chain Loosening Repair">
                        ...
                        <div class="row request-buttons">
                            ...
                            <div class="col-md-6 d-grid "> <button class="btn btn-secondary rounded-pill shadow border-0" type="button"><a href="./voBikemech.php">Back</a></button></div>
                        </div>
                    </div>
                </div>
            </div>
